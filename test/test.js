...
test('new', function(t){
  ...
  t.throws(function(){
    run('String.prototype.toLoud = function() { return this.toString() + "!" }; new String("test")')
...
test('const declaration', function(t) {
  t.equal(run('var x = 1; if (true) { const x = 3 }; x'), 1)
  t.equal(run('const x = 2; x'), 2)
  t.throws(function() {
    run('const x = 1; x = 3')
  })
  t.end()
...
// test('pipeline operator', function (t) {
